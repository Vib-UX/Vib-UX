...
|:----:|:------------|:-----------:|:-----------:|:--------:|
| **🦖 T-REX Protocol** | Mining Lightning liquidity → atomic, trustless swaps for zkRollup EVM node hubs — powered by Schnorr + Secp256k1 | [Repo](https://github.com/Vib-UX/Trex) | [Prod](https://trex-protocol.vercel.app/) | 🏅 [ETHGlobal New Delhi 🇮🇳](https://ethglobal.com/events/newdelhi) |
