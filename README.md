...
<span align="right"><img src="https://komarev.com/ghpvc/?username=Vib-UX&style=flat-square&color=blue" alt="Profile Views" /></span> </h3>


<p align="left"> Hacker at heart, shipping on Bitcoin & Web3. I architect, break, and rebuild — from blockchain protocols to DevOps pipelines.<br/> Hackathon-native 🏆 and open-source explorer, always leveling up 📈. </p>
...
---
  ...
  <h3> 📘 About Me &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  <span>
...
- 👨‍💻 Currently building on BTC using Rust 🦀.
...
|:----:|:------------|:-----------:|:-----------:|:--------:|
| **BMCP** | Bitcoin Multichain Protocol enabling EVM execution triggered from native Schnorr-signed Bitcoin transactions | [Repo](https://github.com/Vib-UX/BMCP) | [Prod](https://bmcp-protocol.vercel.app/) | 🏅 [Finalist ETHGlobal 🇦🇷](https://ethglobal.com/showcase/bmcp-pfm11) |
| **QuietGain DCA** | Privacy-first Bitcoin DCA: stack sats using BIP-352 Silent Payments, maintain fiat parity with ln stable channels during BTC volatility, and settle long-term wealth on P2QRH addresses secured with ML-DSA (CRYSTALS-Dilithium) for post-quantum safety | [Repo](https://github.com/Vib-UX/dca-bitcoin) | [POC](https://youtu.be/GuQ9_8BN3Pc) | [🟧 btc++ Sovereignty Edition 🇹🇼](https://devpost.com/software/quietgain-dca) |
...
| **HyperInsure** | The first on-chain insurance protocol safeguarding users against transaction latency, mempool congestion, and finality risk — delivering predictable execution backed by Stacks and Bitcoin-grade security | [Repo](https://github.com/AmaanSayyad/hyperinsure) | [App](https://hyperinsure-stx-testnet.vercel.app/) | [🏆 Stacks Hacker House Winner 🇦🇷](https://x.com/hyperinsure/status/1998369778231341491?s=20) |
...
| **⚡ BTC UTXO Indexer (Rust)** |  UTXO Indexer Selector addressing large UTXO-set management via indexing, aggregation, and selection to make apps faster, lighter, and more private; optimizing BTC infra. | [Repo](https://github.com/Vib-UX/midl-x-bitcoin-summit-hackathon-2025/tree/main/tracks/track-1/utxo-indexer-selector#%EF%B8%8F-architecture) | [Docker](https://github.com/Vib-UX/midl-x-bitcoin-summit-hackathon-2025/tree/main/tracks/track-1/utxo-indexer-selector#1-start-bitcoin-regtest) | 🏅 [BTC Hack Asia 🇭🇰](https://x.com/midl_xyz/status/1960683184242192669) |
...
<h4>Glittr.fi (DeFi on Bitcoin)</h4>
<ul>
...
<ul>
  <li>🚀 Lightning Network Daemon (Go) <a href="https://btc-101.notion.site/LND-Open-Source-276c182b395e801da4d4f08ccdaea0f4">Project Details</a>
    <ul>
      ...
      <li>⚡ Upgraded <code>btcwallet</code> to support asynchronous calls, boosting responsiveness across the Lightning Network ecosystem. <a href="https://github.com/Vib-UX/btcwallet/pull/1">GitHub PR</a></li>
    </ul>
  </li>
  <li>⚡ Node Lightning (Node.js)
    <ul>
      <li>🔄 Refactored message types in <code>@node-lightning/bitcoin</code> library for enhanced interoperability. <a href="https://github.com/node-lightning/node-lightning/pull/187">GitHub PR</a></li>
      <li>🔐 Improved compliance with peer protocol’s <a href="https://github.com/lightning/bolts/blob/master/02-peer-protocol.md#closing-initiation-shutdown">shutdown initiation</a> to ensure smooth closure of connections. <a href="https://github.com/node-lightning/node-lightning/pull/185">GitHub PR</a> <a href="https://github.com/node-lightning/node-lightning/pull/182">GitHub PR</a></li>
      <li>🛣️ Developed routing logic for the network graph project, optimizing routes with minimized fees along the path. <a href="https://github.com/node-lightning/node-lightning/pull/192">GitHub PR</a></li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>🚀 Provided the custom n-lane Multihop solution for Chainlink Cross-Chain-Interoperability Protocol, earning a notable mention @ETHGlobal. <a href="https://github.com/medX-Superhacks/CCIP-router">GitHub Repo</a></li>
</ul>

<h4>XMTP</h4>
<ul>
  <li>🤖 Added functionality to enable bot replies within the quickstart-frame integration, addressing limitations in handling bot replies created using message-kit. <a href="https://github.com/xmtp/xmtp-quickstart-frames/pull/9">GitHub PR</a></li>
</ul>

<h4>Ethereum Attestation Service</h4>
<ul>
  <li>🔧 <strong>Fix:</strong> Replaced deprecated <code>dataRoot</code> references with <code>privateData</code> in the <code>SchemaEncoder</code>, aligning with the latest EAS SDK updates. <a href="https://github.com/ethereum-attestation-service/eas-sdk/pull/113">GitHub PR</a></li>
</ul>
